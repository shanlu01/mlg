...
pdfCluster::adj.rand.index(seurat.obj$seurat_clusters, cell_info$cell_type_label)
...
# Changing resolution in quantileAlignSNF does not change number of cluster in this example dataset.
...
clustering_acc <- c(pdfCluster::adj.rand.index(seurat.obj$seurat_clusters, cell_info$cell_type_label),
  pdfCluster::adj.rand.index(cnmf_cluster, cell_info$cell_type_label),
  pdfCluster::adj.rand.index(kowalczyk.integrated$seurat_clusters, cell_info$cell_type_label),
  pdfCluster::adj.rand.index(liger.obj@clusters, cell_info$cell_type_label),
  pdfCluster::adj.rand.index(MLG, cell_info$cell_type_label))
